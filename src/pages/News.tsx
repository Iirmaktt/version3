  ...
  const newsArticles = [
    {
      ...
      excerpt: "SCİWELD araştırmacıları, kuantum noktalar kullanarak kanser hücrelerini hedefleyen yeni bir tedavi yöntemi geliştirdi. Bu yenilikçi yaklaşım, geleneksel kemoterapi yöntemlerine göre %80 daha etkili sonuçlar gösteriyor.",
      content: "Nanoteknoloji alanındaki son gelişmeler, tıp dünyasında devrim niteliğinde değişikliklere yol açıyor. SCİWELD'in geliştirdiği kuantum nokta teknolojisi, kanser hücrelerini seçici olarak hedefleyerek sağlıklı dokulara zarar vermeden tedavi imkanı sunuyor. Bu teknoloji, özellikle erken evre kanser vakalarında umut verici sonuçlar göstermektedir.",
      date: "2025-01-15",
    ...
    },
    {
      ...
      content: "Enerji depolama teknolojilerinde yaşanan bu büyük atılım, elektrikli araçların menzil problemini çözmeye yönelik önemli bir adım. SCİWELD'in geliştirdiği nano yapılı elektrot malzemeleri, şarj süresini %70 azaltırken, batarya ömrünü iki katına çıkarıyor.",
      date: "2025-01-12",
    ...
    },
    {
      ...
      excerpt: "SCİWELD'in antibakteriyel nano kaplama teknolojisi, hastane ortamlarında test edildi. Sonuçlar, enfeksiyon oranlarında dramatik düşüş gösterdi ve hasta güvenliğinde yeni bir standart oluşturdu.",
      content: "Hastane kaynaklı enfeksiyonlar, dünya genelinde önemli bir sağlık sorunu. SCİWELD'in geliştirdiği gümüş nanopartikül içeren yüzey kaplamaları, bakterileri %99.9 oranında etkisiz hale getiriyor. Bu teknoloji, ameliyathane ekipmanlarından hasta yataklarına kadar geniş bir kullanım alanına sahip.",
      date: "2025-01-10",
    ...
    },
    {
      ...
      content: "Su kirliliği, küresel çevre sorunlarının başında geliyor. SCİWELD'in grafene dayalı nano filtre sistemi, geleneksel arıtma yöntemlerine göre 10 kat daha etkili. Sistem, düşük enerji tüketimiyle çalışırken, filtre ömrü de geleneksel sistemlerin 5 katı.",
      date: "2025-01-08",
    ...
    },
    {
      ...
      excerpt: "SCİWELD'in geliştirdiği ultra hassas nano sensörler, kan damlasından 15 farklı hastalığı erken aşamada tespit edebiliyor. Bu teknoloji, önleyici tıp alanında devrim yaratacak.",
    ...
    },
    {
      ...
      content: "Savunma sanayiinde malzeme teknolojisi kritik öneme sahip. SCİWELD'in karbon nanotüp takviyeli kompozit malzemeleri, yüksek darbe dayanımı ve hafiflik özelliklerini bir araya getiriyor. Bu malzemeler, askeri araçlardan koruyucu ekipmanlara kadar geniş kullanım alanı buluyor.",
      date: "2025-01-03",
