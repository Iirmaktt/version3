  ...
  const products = [
    {
      ...
      subProducts: [
        ...
        { name: "NAWEL ABRASİON", description: "Aşırı aşınma koşulları için özel geliştirilmiş", specs: "Çap: 1.2-2.4mm, HRC 45-55 sertlik", image: nawelAbrasionImg },
        { name: "NAWEL TUNGSTEN CARBİDE", description: "Ekstrem aşınma için tungsten karbür takviyeli", specs: "Çap: 1.2-2.4mm, HRC 58-65 sertlik", image: nawelTungstenCarbideImg },
        { name: "NAWEL BUİLDUP", description: "Onarım ve yeniden boyutlandırma için", specs: "Çap: 1.2-2.4mm, Yüksek dolgu oranı", image: nawelBuildupImg },
      ],
      image: foto7,
