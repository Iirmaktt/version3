  ...
  const products = [
    {
      ...
      subProducts: [
        ...
        { name: "SCİWELD ABRASİON", description: "Yüksek mukavemet gerektiren uygulamalar", specs: "Çap: 1.2-2.4mm, 550-700 MPa mukavemet", image: nawelAbrasionImg },
        { name: "SCİWELD TUNGSTEN CARBİDE", description: "Yüksek mukavemet gerektiren uygulamalar", specs: "Çap: 1.2-2.4mm, 550-700 MPa mukavemet", image: nawelTungstenCarbideImg },
        { name: "SCİWELD BUİLDUP", description: "Yüksek mukavemet gerektiren uygulamalar", specs: "Çap: 1.2-2.4mm, 550-700 MPa mukavemet", image: nawelBuildupImg },
      ],
      image: foto7,
    ...
    },
    {
      ...
      subProducts: [
        { name: "SCİWELD Plate UltraLight 67T", description: "Genel amaçlı aşınma direnci için", specs: "Sertlik: 370-430 HB, Kalınlık: 6-80mm", image: nawelUltraLight67TImg },
        { name: "SCİWELD Plate Ultrahard 67T", description: "Ağır aşınma koşulları için", specs: "Sertlik: 460-540 HB, Kalınlık: 8-100mm", image: nawelUltraHard67TImg },
        { name: "SCİWELD Plate UltraLight 65", description: "Ekstrem aşınma uygulamaları", specs: "Sertlik: 570-625 HB, Kalınlık: 10-50mm", image: nawelUltraLight65Img },
        { name: "SCİWELD Plate Ultrahard 65", description: "Çok katmanlı hibrit yapı", specs: "Değişken sertlik, 15-120mm kalınlık", image: nawelUltraHard65Img },
        { name: "SCİWELD Plate Ultrahard 70T", description: "Çok katmanlı hibrit yapı", specs: "Değişken sertlik, 15-120mm kalınlık", image: nawelUltraHard70TImg },
      ],
      image: foto9,
